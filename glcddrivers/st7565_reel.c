...
cDriverST7565R::cDriverST7565R(cDriverConfig * config) : cDriver(config)
{
...
int cDriverST7565R::DeInit(void)
{
    //clear_display();
...
int cDriverST7565R::CheckSetup(void)
{
...
void cDriverST7565R::Clear(void)
{
...
void cDriverST7565R::SetPixel(int x, int y, uint32_t data)
{
    if (x >= width || y >= height)
        return;
...
void cDriverST7565R::display_data(unsigned char *data, unsigned char l)
{
    if (l > 60)
    {
...
void cDriverST7565R::set_displaymode(unsigned char m)
{
